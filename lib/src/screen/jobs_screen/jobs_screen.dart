                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      customeCardText(name: 'Year', fontSize: 14)
                    ],
                  )
                ],
              ),
...
// this widget handle the notificationIconButton state if it has notification or not.
...
// this hasNotificationFunction function is used to change notification icon status, while invoking it.
...
// the ValueChanger class is used to retrieve initial values, may we get it from shared preferience in #futuretodo
class ButtonValueChanger {
